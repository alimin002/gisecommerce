...
?>
		<div class="row">
				...
				<div class="row">
					...
					<div class="row">
						<input type="text" class="col-md-12" id="no_transaksi" name='no_transaksi' value='<?php 
						if(mysql_num_rows($result) == 0){
						echo $strno_transaksi="111";
						
						}else{
						echo "PB".$strno_transaksi; 
						}
		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="row">
						<select class="col-md-12" id="no_transaksi" name="no_transaksi">
						<option>Pilih </option>
							<?php 
							while ($rows = mysql_fetch_object($result))
							{ 
							?>
							<option value="<?php echo $rows->periode; ?>">				
							<?php echo $rows->periode; ?>				
							</option>
							<?php 
							} 
							?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" ">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tambah Transaksi <div id="ajax-tester"></div></h4>
        </div>
		...
		<div class="col-md-12"; style="background-color:#e5e5ff; padding:3%;">
		  ...
		  <div class="row">
		       <div class="col-md-9">
                        <input type="text" name="no_transaksi" id="no_transaksi" class="form-control" style="width:120%;">
			   </div>
		  ...
		  <div class="col-md-12">
		   ...
		   <div class="col-md-12">
						...
						<div class="row">
						<div class="col-md-12">
						<label class="col-md-5">Perkiraan</label>
						</div>
						</div>
						<div class="row">
						<div class="col-md-12">
                        <input type="text" name="periode" id="hperiode" class="form-control">
						</div>
						</div>
						<div class="row">
						<div class="col-md-12">
						<label class="col-md-5">Debet</label>
						</div>
						</div>
						...
						<div class="row">
						<div class="col-md-12">
						<label class="col-md-5">Kredit</label>
						</div>
						</div>
						...
						<div class="row">
						<div class="col-md-6">
						<label class="col-md-5">total Debet</label>
						</div>
						</div>
						<div class="row">
						<div class="col-md-12">
						...
						<div class="row">
						<div class="col-md-6">
						<label class="col-md-5">total Kredit</label>
						</div>
						</div>
						<div class="row">
						<div class="col-md-12">
